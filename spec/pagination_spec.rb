...
describe 'pagination' do
  ...
  context 'with 20 items and 10 per page' do
    ...
    it 'has 2 pages for 20 total artsyRobots' do
      object = double(:object, items: items, first: 10, last: nil)
      results = PageCursorResolver.new(object, nil)
    ...
    it 'has 2 around pages' do
      ...
      object = double(:object, items: items, first: 10, last: nil, edge_nodes: edge_nodes)
      results = PageCursorResolver.new(object, nil)
  ...
  context 'with 60 items and 10 per page' do
    ...
    context 'on page 3' do
      it 'has 4 around pages and a last page' do
        ...
        object = double(:object, items: items, first: 10, after: page_three_cursor, last: nil, edge_nodes: edge_nodes)
        results = PageCursorResolver.new(object, nil)
    ...
    context 'on page 5' do
      it 'has 3 around pages and both first and last page' do
        ...
        object = double(:object, items: items, first: 10, after: page_four_cursor, last: nil, edge_nodes: edge_nodes)
        results = PageCursorResolver.new(object, nil)
        ...
        object = double(:object, items: items, first: 10, after: page_five_cursor, last: nil, edge_nodes: edge_nodes)
        results = PageCursorResolver.new(object, nil)
